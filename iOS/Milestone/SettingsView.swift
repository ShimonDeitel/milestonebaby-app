        ...
        NavigationStack {
            List {
                ...
                Section("Subscription") {
                    if purchases.isPro {
                        Label("Milestone Pro active", systemImage: "checkmark.seal.fill")
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/milestonebaby-app/privacy.html")!)
                    Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/milestonebaby-app/terms.html")!)
                    Text("Version 1.0")
                        .foregroundStyle(Theme.textMuted)
                }
            }
